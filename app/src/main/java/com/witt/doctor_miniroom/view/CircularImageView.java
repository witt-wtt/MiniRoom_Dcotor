...
public class CircularImageView extends AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShowFlag && mFlagText != null) {
            ...
            canvas.drawText(mFlagText, getWidth() / 2,
                    (3 + (float) Math.ceil((float) (Math.PI * 5 / 18)))
        ...
        try {
            ...
            if (drawable instanceof ColorDrawable) {
                ...
                bitmap = Bitmap.createBitmap(
                        drawable.getIntrinsicWidth() <= 0 ? 2 : drawable
                                .getIntrinsicWidth(),
                        drawable.getIntrinsicHeight() <= 0 ? 2 : drawable
    ...
    private void setup() {
        ...
        mSweepGradient = new SweepGradient(getWidth() / 2, getHeight() / 2,
                new int[]{Color.rgb(253, 120, 25), Color.rgb(253, 120, 25)},
                null);
        // 修改后的橙色    253,120,25
        //原来的渐变蓝色   1, 209, 255
